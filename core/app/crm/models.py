...
class CallReport (models.Model):
    ...
    last_purchase = models.DateField (verbose_name=_("Last Purchase"),blank=True, null=True)
    purchase_satisfaction = models.BooleanField (verbose_name=_("Purchase Satisfaction"),default=False, blank=True)

    validation = models.BooleanField (verbose_name=_("Validation"),default=False, blank=True)
